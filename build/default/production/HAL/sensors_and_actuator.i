...
# 2 "<built-in>" 2
# 1 "HAL/sensors_and_actuator.c" 2
# 1 "HAL/sensors_and_actuarors.h" 1
# 14 "HAL/sensors_and_actuarors.h"
# 1 "HAL/../MCAL/DIO.h" 1
# 11 "HAL/../MCAL/DIO.h"
...
# 14 "HAL/sensors_and_actuarors.h" 2
...
void void_start_heating()
{
   ...
   void_write_pin('c',5,1);
   void_write_pin('c',0,1);
   void_write_pin('b',7,1);
...
void void_stop_heating()
{
   ...
   void_write_pin('c',5,0);
   void_write_pin('c',0,0);
   void_write_pin('b',7,0);
