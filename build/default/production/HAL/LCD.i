...
delay_ms(10);
delay_ms(10);
void_lcd_send_command(0x28);
void_lcd_send_command(0x0c);
void_lcd_send_command(0x06);
void_lcd_send_command(0x80);
delay_ms(20);
}
void void_lcd_send_command( char command)
{
 ...
 void_write_port('d',(command &0xf0));
 void_pulse();
 void_write_port('d',((command &0x0f)<<4));
 void_pulse();
...
void void_lcd_send_data( char data)
{
 ...
 void_write_pin('e',2,1);
 void_write_port('d',(data &0xf0));
 void_pulse();
 void_write_port('d',((data &0x0f)<<4));
 void_pulse();
...
void void_pulse()
{
 void_write_pin('e',1,1);
 delay_ms(1);
 void_write_pin('e',1,0);
 delay_ms(1);
}
